...
const desc =
  "NUST Institute number one world class university in the world There are student are studying always in this university for all time.";
...
const tweetList = [
  ...
  },
  {
    ...
    desc: (
      <p>
        Usama Shahbaz <a href="#">@OnlineShopping Hey! #HTML_Template</a> Grab
